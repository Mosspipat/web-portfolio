...
const RenderLI = ({ year: date, title, description, link }: renderLIProps) => {
  return (
...
export const TimelineSection = memo(function TimelineSection() {
  return (
    <>
      ...
      <ol className="relative border-s border-gray-200 dark:border-gray-700 h-full flex flex-col justify-center">
