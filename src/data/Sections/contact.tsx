...
export const contactInfoList: ContactInfo[] = [
  {
    ...
    icon: <MdEmail size={28} color="#1b6ccf" />,
    onClick: () => {
  ...
  },
  {
    ...
    label: "064-637-9555",
    value: "064-637-9555",
    icon: <FaPhoneFlip size={28} color="#1b6ccf" />,
    onClick: () => {
  ...
  },
  {
    ...
    icon: <FaSquareInstagram size={28} color="#1b6ccf" />,
    onClick: () => {
  ...
  },
  {
    ...
    icon: <FaFacebookSquare size={28} color="#1b6ccf" />,
    onClick: () => {
  ...
  },
  {
    ...
    icon: <FaGithub size={28} color="#1b6ccf" />,
    onClick: () => {
  ...
  },
  {
    ...
    icon: <FaLinkedin size={28} color="#1b6ccf" />,
    onClick: () => {
      window.open(
        "https://www.linkedin.com/in/%E0%B8%9E%E0%B8%B4%E0%B8%9E%E0%B8%B1%E0%B8%92%E0%B8%99%E0%B9%8C-%E0%B8%AB%E0%B8%AD%E0%B8%A3%E0%B8%B0%E0%B8%86%E0%B8%B1%E0%B8%87%E0%B8%97%E0%B8%AD%E0%B8%87-66786a25b/",
        "_blank"
